...
QString PlanetViewer::helpString () const
{
	...
	text +=
			"You can respectively revolve around and translate with the two mouse buttons. ";
	text +=
			"Left button pressed together rotate around the camera view direction axis<br><br>";
	text +=
			"Press <b>F</b> to toggle the frame rate, <b>A</b> for the world axis, ";
	text +=
			"<b>Alt+Return</b> for full screen mode and <b>Control+S</b> to save a snapshot.";
	text +=
			"See the <b>Keyboard</b> tab in this window for a complete shortcut list.";
	text +=
			"Holding the <b>M</b> key with the viewer selected will move the plates continuously. Pressing <b>C</b> will center the planet in the viewer.";
    text +=            
            "Press the <b>W</b> key to change the display mode (between wireframe and solid).<br><br>";
	text +=
